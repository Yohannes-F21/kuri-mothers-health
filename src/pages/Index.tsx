...
const pillars = [
  ...
  { icon: Heart, title: "Expert Guidance", desc: "Trusted advice from lactation specialists and maternal health professionals." },
  { icon: Users, title: "Peer Support", desc: "A community of mothers who understand the journey and walk it with you." },
  { icon: Smartphone, title: "Digital Platform", desc: "Modern tools and resources accessible wherever and whenever you need them." },
];
...
const trustReasons = [
  { icon: Leaf, title: "Natural & Carefully Selected", desc: "Every ingredient chosen for safety, efficacy, and tradition." },
  { icon: Heart, title: "Designed for Real Needs", desc: "Built by understanding what mothers actually go through." },
  { icon: Users, title: "Community-Driven", desc: "Shaped by the experiences and feedback of real mothers." },
  { icon: ShieldCheck, title: "Expert-Informed", desc: "Guidance developed with lactation consultants and health professionals." },
  { icon: Globe, title: "Ethiopian, African, Global", desc: "Rooted in Ethiopia with ambition to serve mothers across Africa." },
  { icon: Star, title: "Holistic Approach", desc: "Beyond products — a complete support ecosystem for every mother." },
];

const testimonials = [
  { name: "Meron T.", location: "Addis Ababa", quote: "Kuri gave me the confidence I needed during my first weeks of breastfeeding. The tea helped, but the community changed everything." },
  { name: "Hanna B.", location: "Hawassa", quote: "I didn't know support like this existed. The expert guidance made me feel like I wasn't alone in this journey." },
  { name: "Sara M.", location: "Dire Dawa", quote: "As a second-time mother, I thought I knew it all. Kuri showed me there's always more support to receive and give." },
];

const faqs = [
  { q: "What is Kuri?", a: "Kuri is Ethiopia's first integrated breastfeeding support platform, combining natural lactation products with expert guidance, community support, and digital tools for mothers." },
  { q: "Are Kuri products safe for breastfeeding mothers?", a: "Yes. Our products are made with carefully selected natural ingredients, following traditional wisdom and modern safety standards. Always consult your healthcare provider if you have specific concerns." },
  { q: "How does the support platform work?", a: "Our digital platform connects you with lactation experts, peer support groups, educational content, and personalized guidance — all accessible from your phone." },
  { q: "Is Kuri only for first-time mothers?", a: "Not at all. Kuri supports all breastfeeding mothers, whether it's your first child or your fourth. Every journey is unique and deserves support." },
  { q: "How can I partner with Kuri?", a: "We work with pharmacies, health centers, distributors, and community organizations. Visit our Partners page or contact us to explore collaboration opportunities." },
];
    ...
    <main>
      ...
      <section className="relative min-h-[100vh] flex items-center">
        <div className="absolute inset-0">
          <img src={heroImg} alt="Mother holding her baby with love" width={1920} height={1080} className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-gradient-to-r from-foreground/80 via-foreground/50 to-transparent" />
        </div>
        <div className="relative z-10 section-padding max-w-[1440px] mx-auto w-full pt-32 pb-20">
          <div className="max-w-2xl">
            <p className="label-sm mb-6 text-sage-light">Ethiopia's First Lactation Support Ecosystem</p>
            ...
            <p className="text-lg md:text-xl leading-relaxed text-primary-foreground/80 max-w-lg mb-10">
              Natural lactation products, trusted expert guidance, and a caring community of mothers — everything you need for a supported breastfeeding journey.
            </p>
            <div className="flex flex-wrap gap-4">
              <Button variant="accent" size="xl" asChild>
                <Link to="/products">Explore Products <ArrowRight className="ml-1" /></Link>
              </Button>
              <Button size="xl" className="bg-primary-foreground/15 text-primary-foreground border border-primary-foreground/30 hover:bg-primary-foreground/25 backdrop-blur-sm" asChild>
            ...
            <div className="flex flex-wrap gap-6 mt-12 pt-8 border-t border-primary-foreground/15">
              {["Natural Ingredients", "Expert-Backed", "Mother-Centered", "Ethiopian Brand"].map((cue) => (
                <div key={cue} className="flex items-center gap-2 text-primary-foreground/60 text-sm">
                  <CheckCircle size={14} />
                  <span>{cue}</span>
                </div>
              ))}
      ...
      <section className="section-padding section-y max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {pillars.map((p) => (
            <div key={p.title} className="bg-card rounded-xl p-8 border border-border hover:shadow-md transition-shadow">
        ...
        <div className="section-padding section-y max-w-[1440px] mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="heading-lg mb-6">Breastfeeding is natural. But it isn't always easy.</h2>
              <p className="body-lg mb-8">
                Millions of mothers navigate the breastfeeding journey without adequate support, reliable guidance, or access to safe, natural products. The challenges are real — and they deserve real solutions.
              </p>
          ...
          {[
            ...
            <div key={item.step} className="group">
              <div className="overflow-hidden rounded-xl mb-6">
                <img src={item.img} alt={item.title} loading="lazy" width={800} height={600} className="w-full aspect-[4/3] object-cover group-hover:scale-105 transition-transform duration-700" />
              </div>
            ...
            {[
              ...
              <div key={product.name} className="bg-background rounded-xl overflow-hidden border border-border hover:shadow-lg transition-shadow">
                ...
                <div className="p-6 pt-0">
                  ...
                  <p className="body-md text-sm mb-4">{product.desc}</p>
                  <div className="flex items-center justify-between">
                    <span className="font-serif text-lg font-semibold text-primary">{product.price}</span>
                    <Button variant="hero" size="sm">Learn More</Button>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="section-padding section-y max-w-[1440px] mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="heading-lg mb-6">Beyond products. A digital companion for your journey.</h2>
            <p className="body-lg mb-8">
              Our support platform brings together everything a breastfeeding mother needs — expert guidance, community connection, educational resources, and personalized support — right at your fingertips.
            </p>
            ...
            <div className="mt-8">
              <Button variant="hero" size="lg" asChild>
                <Link to="/services">Explore the Platform <ArrowRight className="ml-1" /></Link>
              </Button>
            </div>
          </div>
          <div className="bg-card rounded-2xl p-8 md:p-12 border border-border">
            <div className="space-y-6">
              {[
                { icon: "💬", label: "Expert Chat", desc: "Connect with lactation specialists" },
                { icon: "👥", label: "Peer Groups", desc: "Join mothers in your area" },
                { icon: "📚", label: "Resources", desc: "Evidence-based guides and tips" },
                { icon: "📊", label: "Your Journey", desc: "Track progress and milestones" },
              ].map((feature) => (
                <div key={feature.label} className="flex items-center gap-4 p-4 bg-background rounded-xl border border-border">
                  <span className="text-2xl">{feature.icon}</span>
                  <div>
                    <p className="font-sans font-semibold text-sm">{feature.label}</p>
      ...
      <section className="bg-card">
        <div className="section-padding section-y max-w-[1440px] mx-auto">
          <SectionHeading
            label="Trust"
            title="Why mothers choose Kuri."
          />
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {trustReasons.map((reason) => (
              <div key={reason.title} className="p-8 rounded-xl bg-background border border-border">
                <reason.icon size={24} className="text-primary mb-4" />
                <h3 className="font-serif text-lg font-semibold mb-2">{reason.title}</h3>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((t) => (
            <div key={t.name} className="bg-card rounded-xl p-8 border border-border">
              ...
              <p className="font-serif text-base italic leading-relaxed mb-6">"{t.quote}"</p>
              <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative section-padding section-y max-w-[1440px] mx-auto text-center">
          <p className="label-sm mb-4 text-primary-foreground/60">Our Mission</p>
          <h2 className="heading-lg text-primary-foreground mb-6 max-w-3xl mx-auto">
            Empowering every mother in Ethiopia — and across Africa — to breastfeed with confidence.
          </h2>
          <p className="body-lg text-primary-foreground/70 max-w-2xl mx-auto mb-10">
            We envision a world where no mother walks the breastfeeding journey alone. From Addis Ababa to the continent, Kuri is building the infrastructure of maternal support.
          </p>
          <div className="grid grid-cols-3 gap-8 max-w-xl mx-auto">
            {[
              ...
              <div key={stat.label}>
                <p className="font-serif text-3xl md:text-4xl font-bold text-primary-foreground">{stat.metric}</p>
      ...
      <section className="section-padding section-y max-w-[1440px] mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="heading-lg mb-6">Grow with Kuri. Partner with purpose.</h2>
            <p className="body-lg mb-6">
              We partner with pharmacies, maternal health centers, distributors, retailers, and organizations committed to improving maternal care across Ethiopia and Africa.
            </p>
            <ul className="space-y-3 mb-8">
              {["Pharmacies & retail partners", "Maternal & child health centers", "NGOs & community organizations", "Distributors & wholesale partners"].map((item) => (
            ...
            <Button variant="hero" size="lg" asChild>
              <Link to="/partners">Partner with Kuri <ArrowRight className="ml-1" /></Link>
            </Button>
          </div>
          <div className="bg-card rounded-2xl p-10 border border-border text-center">
            ...
            <p className="body-md mb-6">Join a growing network of partners dedicated to supporting mothers and building healthier communities.</p>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="text-center mt-8">
              <Button variant="ghost" asChild>
                <Link to="/faq">View All FAQs <ArrowRight className="ml-1" /></Link>
              </Button>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding section-y max-w-[1440px] mx-auto text-center">
        ...
        <p className="body-lg max-w-xl mx-auto mb-10">
          Whether you're a new mother seeking support or a partner looking to make a difference — Kuri is here for you.
        </p>
